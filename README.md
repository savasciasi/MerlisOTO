...
> - Çok monitörlü kurulumlarda sol (negatif koordinatlı) ekranlar için DXCam tüm sanal masaüstünü yakalayıp hedef pencereyi kırpar; bu nedenle `config.json` içindeki ROI değerleri pencereyi kapsayacak şekilde kalmalıdır.
